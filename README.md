...
| UI (mobile)      | nativewind (Tailwind v4)                                              |
| Lint / format    | Biome                                                                 |
...
- `mobile` — expo, expo-router, expo-secure-store, react-native, nativewind
- `auth` — @oslojs/{crypto,encoding}, arctic
- `validation` — zod, drizzle-zod, i18next
...
- Stripe webhook handlers (the SDK is exposed via DI for seeders to consume)
