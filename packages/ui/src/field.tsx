...
const fieldLabelVariants = cva(
  "gap-2 text-sm font-medium group-data-[disabled=true]/field:opacity-50 flex w-fit items-center leading-snug",
  {
    variants: {
      variant: {
        label:
          "text-sm pb-0.5 font-medium group-data-[disabled=true]/field:opacity-50 flex w-fit items-center leading-snug text-xs font-medium text-stone-600 mb-1.5 block",
        title:
          "text-sm font-medium group-data-[disabled=true]/field:opacity-50 flex w-fit items-center leading-snug",
      },
    },
  }
);
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "text-stone-500 text-left text-sm leading-normal font-normal",
        "[[data-variant=legend]+&]:-mt-1.5",
        "group-has-[[data-orientation=horizontal]]/field:text-balance",
        "last:mt-0 nth-last-2:-mt-1",
        "[&>a:hover]:text-stone-700 [&>a]:underline [&>a]:underline-offset-4",
        className
      )}
      {...props}
    />
