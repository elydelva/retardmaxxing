    ...
    <div className="min-h-screen bg-[#F6F4ED] flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center space-y-8">
        ...
        <div className="space-y-3">
          <h2 className="font-serif text-2xl md:text-3xl font-medium text-stone-800">{message}</h2>
        ...
        <div className="pt-12">
          <p className="font-serif text-xl font-bold tracking-tight text-stone-300">Swaya.</p>
        </div>
      </div>
    </div>
  );
