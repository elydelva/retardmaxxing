...
function SidebarProvider({
	...
	const contextValue = React.useMemo<SidebarContextProps>(
		...
		[state, open, setOpen, isMobile, openMobile, toggleSidebar, customStyles],
	);
				...
				style={
					{
						...
						"--sidebar-background": customStyles?.background,
						"--sidebar-foreground": customStyles?.foreground,
						"--sidebar-accent": customStyles?.accent,
						"--sidebar-accent-foreground": customStyles?.accentForeground,
						"--sidebar-border": customStyles?.border,
						...style,
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn(
				"no-scrollbar px-2 gap-2 flex min-h-0 flex-1 flex-col overflow-auto group-data-[collapsible=icon]:overflow-hidden",
				className,
			)}
			{...props}
		/>
