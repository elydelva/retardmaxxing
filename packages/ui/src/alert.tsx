	...
	"relative w-full rounded-[1.25rem] border p-4 [&>svg~*]:pl-8 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-stone-950",
	{
		variants: {
			variant: {
				...
				destructive:
					"border-red-100/50 text-red-900 bg-red-50/50 [&>svg]:text-red-600",
				warning:
					"border-orange-100/50 text-orange-900 bg-orange-50/50 [&>svg]:text-orange-600",
				info: "border-blue-100/50 text-blue-900 bg-blue-50/50 [&>svg]:text-blue-600",
				success:
					"border-emerald-100/50 text-emerald-900 bg-emerald-50/50 [&>svg]:text-emerald-600",
			},
		},
		defaultVariants: {
			variant: "default",
