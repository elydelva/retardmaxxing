    ...
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          ...
          content: "group-[.toast]:pl-5 group-[.toast]:text-sm group-[.toast]:mt-0.5",
        },
      }}
      icons={{
        success: (
        ...
        warning: (
          <div className="w-8 h-8 rounded-xl bg-amber-50 flex items-center justify-center shrink-0">
            <AlertTriangle strokeWidth={2.5} className="size-4 text-amber-500" />
          </div>
        ),
        error: (
        ...
        loading: (
          <div className="w-8 h-8 rounded-xl bg-stone-100 flex items-center justify-center shrink-0">
            <Loader2 strokeWidth={2.5} className="size-4 text-stone-500 animate-spin" />
          </div>
        ),
      }}
      {...props}
